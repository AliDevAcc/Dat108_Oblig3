...
public class Hashing {
	...
	private static String hashAlgorithm = "SHA-1";			// default is SHA-1
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	public static String generateHashWithSalt(final String password, byte[] salt) throws NoSuchAlgorithmException {
	 ...
	 */
	public static String getPasswordHashinHex() {
		return passwordHash;
	}
